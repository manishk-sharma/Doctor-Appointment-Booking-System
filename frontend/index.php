<?php
include_once(__DIR__ . '/../backend/include/config.php');
...
<head>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 0.5% !important;">                        
                    <a href="#"><img src="<?=('assets/images/logo.png');?>" style="height: 60px; " alt=""></a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Comprehensive patient care
                            from highly
                            professional doctors</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_2.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Extending the best 
                            medical care 
                            with compassion</h5>
  ...
  <!--  ************************* Logins ************************** -->
    ...
    <center><h3 class="inner-title">About Our System</h3></center>
        <div class="row no-margin">
            <div class="col-sm-6 image-bg no-padding">
                <img src="assets/images/why.jpg" alt="About MEDIQ" class="about-system-image">
            </div>
...
while ($row=mysqli_fetch_array($ret)) {
    $aboutDescription = trim($row['PageDescription']);
    if ($aboutDescription === '') {
        $aboutDescription = 'MEDIQ is a patient-focused healthcare management system that helps patients book appointments, doctors manage care, and administrators keep everything organized.';
    }
?>

    <p><?php echo $aboutDescription; ?></p><?php } ?>
            </div>
        </div>
    </section>    
...
?>
    ...
    <div class="copy">
            <div class="container">
        <center>MediQ &copy; 2025.  All Right Reserved.</center> 
